...
import ITwitchApiV6StreamingEvent from "../handler/itwitch-api-v6-streaming-event";
...
export default class IncomingStreamingCommandEventTranslator extends PollingManager<IPollingStreamingResponse> {
    ...
    private lastStreamingMessageTimestamp: number;
    ...
    constructor(
        ...
        this.lastStreamingMessageTimestamp = Date.now();
    }
