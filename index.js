...
const twitchConnection = new TwitchConnection(twitchWebSocketUri);

twitchConnection.connect().then(() => {
	console.log("Connected.");

	const disconnect = () => twitchConnection.disconnect().then(() => {
	...
	return Promise.resolve().then(() => {
		...
		return twitchConnection.listen(twitchUserAccessToken, topics, dataHandler).then((killSwitch) => {
